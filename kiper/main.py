...
def SendEmail(user, pwd, recipient, subject, body):
    ...
    gmail_pass=pwd
    FROM = user
    TO = recipient if type(recipient) is list else [recipiente]
    SUBJECT = subject
    TEXT = body
...
def FormatAndSendLogEmail():
    with open(file_log, 'r+') as f:
        ...
        SendEmail('calculando.estimando@gmail.com','password','calculando.estimando@gmail.com',
